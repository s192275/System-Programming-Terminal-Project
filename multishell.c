/*
 UMUTCAN MERT  : addr'ye yazma islemi, multishell'de shellog dosyasi olusturma ve addr'yi shelloga atma
 SERHAT KILIC  : loglari hashleme(ekstra fonksiyon), calisma zamani ve pid'leri dosyaya atma 
 MUHAMMED NIHAT AYDIN  : addr'ye yazma islemi, renklendirme (ekstra fonksiyon)
 MUHAMMET HAMZA YAVUZ  : birden fazla xtermle acma, loglari hashleme
